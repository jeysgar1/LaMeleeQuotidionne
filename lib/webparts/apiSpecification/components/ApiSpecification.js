...
var ApiSpecification = /** @class */ (function (_super) {
    __extends(ApiSpecification, _super);
    function ApiSpecification(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {};
        return _this;
    }
    ApiSpecification.prototype.render = function () {
            ...
            React.createElement(Item, null,
                ...
                React.createElement(Item.Content, null,
                    ...
                    React.createElement(Item.Meta, null,
                        React.createElement("span", { className: 'price' }, this.props.Verb),
                        React.createElement("span", { className: 'stay' }, this.props.BaseURL),
